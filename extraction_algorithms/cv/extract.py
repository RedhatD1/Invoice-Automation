...
def get_json(pdf_file_name, job_description, algorithm='default'):
    pdf_file_path = f"documents/cv/{pdf_file_name}"
    return pdfToInfo.extract_info(pdf_file_path, job_description)

#
# # Example Usage
# pdf_file_name = 'abidbhai.pdf'
# job_description = """
# Job Title: PHP Web Developer & Team Leader
#
# Job Description:
#
# We are seeking an experienced and skilled PHP Web Developer & Team Leader to join our dynamic team. As a core
# member of our development team, you will be responsible for the end-to-end development of web applications,
# ensuring seamless integration of front-end and back-end components. Your role will involve leading and mentoring a
# team of developers, overseeing project progress, and collaborating with stakeholders throughout the development
# lifecycle.
#
...
# """
#
# output = get_json(pdf_file_name, job_description)
